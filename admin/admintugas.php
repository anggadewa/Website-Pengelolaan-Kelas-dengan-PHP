...
<body>
  ...
  <div id="right-panel" class="right-panel">
    ...
    <div class="content mt-3">
      <div class="col-lg-12">
        <form action="admintugas.php" method="post">
          <!-- <p><b>NAMA</b></p> -->
          ...
          <p><b>DESKRIPSI TUGAS</b></p>
          <textarea name="deskripsi" placeholder="Deskripsi Tugas" class="inputrounded"></textarea><br> <br>
      ...
      if(isset($_POST['submit'])){
        ...
        $query = "INSERT INTO infotugas (nama, matkul, deskripsi) VALUES ('$nama', '$matkul', '$deskripsi')";
        $result = mysqli_query($link, $query);
        echo "<center><h3>Tugas Berhasil Ditambahkan</h3><center>";
      }
      ?>
