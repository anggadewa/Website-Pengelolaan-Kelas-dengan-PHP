        ...
        <div class="col-md-12">
          <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
            ...
            <tbody>
              ...
              $no = 1;
              $data = mysqli_query($link,"SELECT * from upload ORDER BY `periode` DESC");
              while($r = mysqli_fetch_array($data)){
                ...
                <tr>
                  ...
                  <td><?php echo "<a href=\"download/simpandownload.php?file=$r[file]\" class='atable'>$r[file]</a>"; ?></td> &emsp;&emsp;&ensp;</td>
