  ...
  <div id="right-panel" class="right-panel">
    ...
    <div class="content mt-3">
      ...
      if(isset($_POST['submit'])){
        ...
        $query = "INSERT INTO infolab (nama, matkul, deskripsi) VALUES ('$nama', '$matkul', '$deskripsi')";
