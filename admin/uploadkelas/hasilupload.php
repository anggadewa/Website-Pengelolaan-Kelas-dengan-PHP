        ...
        <div class="col-md-12">
          <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
            ...
            <tbody>
              ...
              $no = 1;
              $data = mysqli_query($link,"SELECT * FROM upload_kelas WHERE kode_admin = '$kodeadmin' ORDER BY `periode` DESC");
              while($h = mysqli_fetch_array($data)){
                ?>
                <tr>
                  <td><?php echo $h['kode_admin'] ;?>&emsp;&emsp;</td>
                  <td><?php echo $h['nama'] ;?>&emsp;&emsp;</td>
                  <td><?php echo $h['matkul'] ;?>&emsp;&emsp;</td>
                  <td><?php echo $h['periode']; ?>&emsp;&emsp;</td>
                  <td><?php echo $h['file']; ?>&emsp;&emsp;</td>
                  <td><?php echo $h['deskripsi']; ?>&emsp;&emsp;</td>
                  <td><?php echo $h['tgl_upload']; ?>&emsp;&emsp;</td>
                  <td>
                    <br>
                    <a href="hapusupload.php?id_upload=<?php echo $h['id_upload'];?>"> <strong>HAPUS</strong></a>
                    <br>
                    <hr>
                  </td>
                </tr>
