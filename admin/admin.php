    ...
    <nav class="navbar navbar-expand-sm navbar-default">
      ...
      <div id="main-menu" class="main-menu collapse navbar-collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="menu-item-has-children dropdown">
            <a href="admindownload.php"> <i class="menu-icon fa fa-download"></i>Download Tugas</a>
          </li>
            ...
            <div class="dropdown float-right">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <div class="dropdown-menu-content">
                  <a class="dropdown-item" href="admintugas.php">Informasi Tugas</a>
                  <a class="dropdown-item" href="adminkelas.php">Informasi Kelas</a>
                  <a class="dropdown-item" href="adminlab.php">Informasi Laboratorium</a>
                </div>
              </div>
            </div>
            <h4 class="mb-0">
        ...
        <div class="card text-white bg-flat-color-2">
          <div class="card-body pb-0">
            <div class="dropdown float-right">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <div class="dropdown-menu-content">
                  <a class="dropdown-item" href="adminuploadkelas.php">Upload Materi Kelas</a>
                  <a class="dropdown-item" href="adminuploadlab.php">Upload Materi Lab</a>
                </div>
              </div>
            </div>
            <h4 class="mb-0">
        ...
        <div class="card text-white bg-flat-color-3">
          <div class="card-body pb-0">
            <div class="dropdown float-right">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <div class="dropdown-menu-content">
                  <a class="dropdown-item" href="admindownload.php">Download Tugas</a>
                </div>
              </div>
            </div>
            <h4 class="mb-0">
        ...
        <div class="card text-white bg-flat-color-4">
          <div class="card-body pb-0">
            <div class="dropdown float-right">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <div class="dropdown-menu-content">
                  <a class="dropdown-item" href="admintambah.php">Tambah Akun</a>
                  <a class="dropdown-item" href="adminedit.php">Edit Akun</a>
                  <a class="dropdown-item" href="adminhapus.php">Hapus Akun</a>
                  <!-- <a class="dropdown-item" href="adminganti.php">Ganti Password Akun</a> -->
                </div>
              </div>
            </div>
            <h4 class="mb-0">
