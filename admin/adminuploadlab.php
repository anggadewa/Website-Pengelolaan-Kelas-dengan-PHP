...
<body>
  ...
  <div id="right-panel" class="right-panel">
    ...
    <div class="content mt-3">
      <div class="col-lg-12">
        <form action="uploadlab/dbuploadlab.php" method="post" enctype="multipart/form-data">
          ...
          <input type="text" name="matkul" placeholder="Mata Praktikum" class="inputrounded"> <br><br>
          <input type="text" name="periode" placeholder="Pertemuan Ke-" class="inputrounded"> <br><br>
          ...
          <input type="submit" name="submit" value="UPLOAD MATERI" class="btn btn-outline-primary btn-lg"> <br><br>

          <h3> <a href="uploadlab/hasilupload.php" class="warnateks"> CEK DATA</a> </h3> <br><br>
