...
<body>
  ...
  <div class="container">
    <div class="row mt presentation">
      <h1 class="centered">DOWNLOAD MATERI</h1>
      <hr>
    </div>
  </div>
  <div class="container">
    <h2>DOWNLOAD MATERI LAB 4IA18</h2>
    <hr>
      <div class="table-responsive">
          <table class="table table-hover table-bordered table-striped" id="datatables">
            ...
            <tbody>
              ...
              $no = 1;
              $data = mysqli_query($link,"SELECT * from upload_lab ORDER BY `periode` DESC");
              while($r = mysqli_fetch_array($data)){
                ?>
                <tr>
                  <td><?php echo $no++?></td>
                  <td><?php echo $r['matkul'] ;?></td>
                  <td><?php echo "<a href=\"downloadlab/simpandownload.php?file=$r[file]\" class='atable'>$r[file]</a>"; ?></td> &emsp;&emsp;&ensp;</td>
