    ...
    <div class="table-responsive">
      <table class="table table-hover table-bordered table-striped" id="datatables">
        ...
        <tbody>
          <tr>
            <td>MATERI KELAS</td>
            <td> <button type="button" name="button" class="button"> <a href="downloadkelas.php"> DOWNLOAD </a> </button> </td>
          </tr>
          <tr>
            <td>MATERI LAB</td>
            <td> <button type="button" name="button" class="button"> <a href="downloadlab.php"> DOWNLOAD </a> </button> </td>
          </tr>
        </tbody>
      </table>
      <br><br><br>
